...
summary_tab <- div(
  ...
  fluidRow(
    column(width = 2,
           # shinyjs::showElement(actionButton("pur_submit", "Verify", class = "btn btn-primary")),
           # shinyjs::hideElement(actionButton("pur_submitFinal", "Submit", class = "btn btn-primary")),
           actionButton("pur_submit", "Verify", class = "btn btn-primary"),
           br()),
    column(width = 2,
...
pur_submit_button = function(session, input, output){
  ...
  # shinyjs::toggleElement("pur_submit")
  # shinyjs::toggleElement("pur_submitFinal")
  
  pur_submitFinal_button(session, input, output)
}

pur_submitFinal_button = function(session, input, output){
  # source("modules/utils/dbCon.R")
  # 
